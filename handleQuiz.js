...
/*--------This will render the question page everytime a button is selected------------*/
function renderPage(){
    console.log(STORE);
        ...
        '<form id="questionAndAnswer">' +
                '<fieldset>' +
                        '<legend class="currentQuestion">' + STORE[question].prompt + '</legend>' +
                            '<div class = "answers">' +
                                '<label for="possibleAnswers1"><input id= "possibleAnswers1" type="radio" name="question1" value="0">' + STORE[question].answers[0] + '</label><br>' +
                                '<label for="possibleAnswers2"><input id= "possibleAnswers2" type="radio" name="question1" value="1">' + STORE[question].answers[1] +  '</label><br>' +
                                '<label for="possibleAnswers3"><input id= "possibleAnswers3" type="radio" name="question1" value="2">' + STORE[question].answers[2] + '</label><br>' +
                                '<label for="possibleAnswers4"><input id= "possibleAnswers4" type="radio" name="question1" value="3">' + STORE[question].answers[3] + '</label><br>' +
...
function correctAnswer(){
    ...
    $('.newPage').remove();
    $('.OpeningPage').append('<div class ="newPage"><header class="header">' +
    '<h1 class="greeting"><img class="logo left" src="https://pwntastic-avatar-production.s3.amazonaws.com/uploads/user/avatar/264188/main_Cayde_6.png" alt="Cayde Thumbs Up">Correct!!!!!!<img class="logo right" src="https://i.imgur.com/qlTdyrR.jpg" alt="Happy Zavala"></h1>' +
'</header>' +
'<main class="correctMain">' +
    '<div class="counter">' +
        '<p class="correct">' + rightScore + ' of 10 correct</p>' +
...
function wrongAnswer(){
    ...
    $('.OpeningPage').append('<div class = "newPage"><header class="header">' +
    '<h1 class="greeting"><img class="logo left" src="https://img05.deviantart.net/201c/i/2015/166/8/5/oryx__the_taken_king_by_b1izzardhawkfa-d8xhffu.png" alt="Oryx">***Incorrect***<img class="logo right" src="https://cdn.vox-cdn.com/thumbor/xDzUsp6lU_D6tVJaZjpKxwjuiKg=/0x0:1920x1080/920x613/filters:focal(807x387:1113x693):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/64702054/calus.0.png" alt="Emperor Calus"></h1>' +
'</header>' +
'<main class="correctMain">' +
    '<div class="counter">' +
        '<p class="correct">' + rightScore + ' of 10 correct</p>' +
