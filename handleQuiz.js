...
function renderPage(){
    ...
    console.log(question);
        ...
        '<h1 class="questionTitle"><img class="logo left" src="https://www.destructoid.com//ul/262753-destiny.jpg" alt="Destiny 1 Box Art">Destiny Quiz</h1>' +
        '<div class="centeredLogo">'+
                    '<img class="logo right" src="https://i.redd.it/qchrru6vt7dz.jpg" alt="Destiny 2 Logo">'+
        '</div>'+
    '</header>' +
    '<main class="main">' +
...
function correctAnswer(){
    ...
    $('.newPage').remove();
    $('.OpeningPage').append('<div class ="newPage"><header class="header">' +
    '<h1 class="correctTitle"><img class="logo left" src="https://pwntastic-avatar-production.s3.amazonaws.com/uploads/user/avatar/264188/main_Cayde_6.png" alt="Cayde Thumbs Up">Correct!!!!!!</h1>' +
    '<div class="centeredLogo">'+
        '<img class="logo right" src="https://i.imgur.com/qlTdyrR.jpg" alt="Happy Zavala">'+
    '</div>'+
'</header>' +
...
function renderEndGame(){
    ...
    $('body').attr('class', 'OpeningPage');
    $('.OpeningPage').append('<div class = newPage><header class="header">' +
    '<h1 class="greeting"><img class="logo left" src="https://cdn.images.express.co.uk/img/dynamic/143/590x/Destiny-s-Iron-Banner-returns-for-Rise-of-Iron-717946.jpg" alt="Guardians Assembled">All questions completed</h1>' +
    '<div class="centeredLogo">'+
    '<img class="logo right" src="https://i0.wp.com/metro.co.uk/wp-content/uploads/2017/07/d2_pvp_heroic_02_1500378118.jpg?quality=90&strip=all&zoom=1&resize=644%2C362&ssl=1" alt="Destiny Logo">'+
'</div>'+
'</header>'+
